...
urlpatterns = [
    ...
    path("authrization/error/", views.error_page, name="error_page"),
    path(
        "authrization/forget_password/", views.forget_password, name="forget_password"
    ),
    path(
        "authrization/change_password/<auth_token>/",
        views.change_password,
        name="change_password",
    ),
    path(
        "authrization/vehicle_details/<str:username>",
        views.vehicle_details,
        name="vehicle_details",
    ),
    path(
        "authrization/Add_vehicle/<str:username>", views.Add_vehicle, name="Add_vehicle"
    ),
    path(
        "authrization/delete_vehicle/<str:username>/<str:vehicle_number>/",
    ...
    # =====================================================
    path(
        "authrization/pricing/download/<str:username>/<str:filename>/",
        views.download_pdf,
        name="download_pdf",
    ),
    path(
        "authrization/pricing/pay_now/<str:username>/<str:filename>/",
        views.pay_now,
        name="pay_now",
    ),
    # Opens Razorpay payment page
    path(
        "authrization/pricing/paybill/<str:username>/<str:filename>/",
        views.paybill,
        name="paybill",
    ),
    # Receives Razorpay payment response
    path(
        "authrization/pricing/payment/verify/",
        views.verify_payment,
        name="verify_payment",
    ),
    path("track-vehicle/<str:username>/", views.track_vehicle, name="track_vehicle"),
    # =====================================================
    # TRIP
    # =====================================================
    path("Trip/", views.Trips_fun, name="Trip"),
    path("Trip/simulation/invoice/", views.invoice, name="invoice"),
    path(
        "Trip/simulation/generate_pdf/<str:username>/<str:uuid_field_value>",
        views.generate_pdf,
        name="generate_pdf",
    ),
    path("Trip/simulation/<str:filename>", views.simulation, name="simulation"),
    path(
        "Trip/get-coordinates/<str:filename>/",
        views.get_coordinates,
